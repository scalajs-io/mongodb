...
lazy val publishingSettings = Seq(
  ...
  pomExtra :=
    <url>https://github.com/ldaniels528/scalajs-node-npm</url>
      ...
      <scm>
        <connection>scm:git:github.com/scalajs-io/mongodb.git</connection>
        <developerConnection>scm:git:git@github.com:scalajs-io/mongodb.git</developerConnection>
        <url>github.com/scalajs-io/mongodb.git</url>
      </scm>
      <developers>
        <developer>
          <id>ldaniels528</id>
